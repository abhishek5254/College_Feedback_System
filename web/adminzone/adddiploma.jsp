         ...
         <li><a href="addengineering.jsp">ENGINEERING CLG</a></li>
          ...
          <li><a href="logout.jsp"> LOGOUT</a></li>
                ...
                <div class="col-sm-12 parent" id="parent" >
                    <div class="row">
                        <div class="col-sm-12" style="min-height: 500px;border: 1px solid;">
                            <div class="col-sm-4" style="min-height:450px;border: 1px solid;"></div>
                            <div class="col-sm-4" style="min-height:450px;border: 1px solid;">
                                <br/>
                                
                                <h2 style="text-align:center;"><u>Add Diploma College Here</u></h2>
                                <br/>
                                <form class="form-horizontal" action="admincode/adddip.jsp" method="post">
                                    <label>College name</label>
                                    <input type="text" class="form-control" name="cname" placeholder="Enter College Name"/>
                                    <br/>
                                    <label>Location</label>
                                    <input type="text" class="form-control" name="location" placeholder="Enter College Location"/>
                                    <br/>
                         ...
                         <div class="col-sm-12" style="min-height:600px; ">
                            ...
                            <div class="col-sm-8" style="min-height: 600px;">
                                ...
                                <%
                                     ...
                                     ResultSet rs=dm.selectQuery("select * from adddiploma");
                                     while(rs.next())
                                     {
                                    ...
                                    <tr>
                                        <td><%=rs.getString("id")%></td>
                                          ...
                                          <td><a href="admincode/deldipclg.jsp?id=<%=rs.getString("id")%>">Delete </a></td>
