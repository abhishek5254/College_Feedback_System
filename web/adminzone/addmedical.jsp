                    ...
                    <div class="row">
                        <div class="col-sm-12" style="min-height: 500px;border: 1px solid;">
                            ...
                            <div class="col-sm-4" style="min-height:450px;border: 1px solid;">
                                ...
                                <h2 style="text-align:center;"><u>Add Medical Clg. Here</u></h2>
                                <br/>
                                <form class="form-horizontal" action="admincode/addmed.jsp" method="post">
                         ...
                         <div class="col-sm-12" style="min-height:600px; ">
                            ...
                            <div class="col-sm-8" style="min-height: 600px;">
                                ...
                                <%
                                     ...
                                     ResultSet rs=dm.selectQuery("select * from addmedical");
                                     while(rs.next())
                                     {
                                    ...
                                    <tr>
                                        <td><%=rs.getString("id")%></td>
                                          ...
                                          <td><a href="admincode/delengclg.jsp?id=<%=rs.getString("id")%>">Delete </a></td>
