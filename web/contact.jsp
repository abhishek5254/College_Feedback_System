                ...
                <div class="col-sm-12 parent" id="parent" style="min-height: 700px;">
                    <div class="row">
                        <div class="col-sm-12 text-center" style="min-height:50px;">
                            <h2 style="font-family:Arial Rounded MT;"><b>Contact here</b></h2>
                        </div>
                        <div class="col-sm-3" style="min-height: 600px;"></div>
                        <div class="col-sm-6" style="min-height: 600px;">
                            <form class="form-horizontal" action="generalcode/enquirycode.jsp" method="post">
                                <br/>
                                 <label>Name</label>
                                ...
                                <textarea name="enquirytext" class="form-control" placeholder="Enter your Enquiry text" required style="resize:none;"></textarea>
                                <br/>
