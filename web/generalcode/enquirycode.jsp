...
<%
    ...
    {
        out.print("<script>window.alert('Enquiry is saved');window.location.href='../index.jsp';</script>");
    }
    else
    {
        out.print("<script>window.alert('Enquiry is not saved');window.location.href='../index.jsp';</script>");
    }
