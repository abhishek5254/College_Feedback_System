        ...
        <li><a href="userlogin.jsp"><i class="fa fa-key"></i> LOGIN</a></li>
          ...
          <li><a href="contact.jsp"><i class="fa fa-phone"></i> CONTACT US</a></li>
                ...
                <div class="col-sm-12 parent" id="parent" >
                    <div class="row">
                        <div class="col-sm-7" style="min-height:550px;background-image: url('images/11.jpeg;');background-attachment: fixed;">
                           
                        </div>
                       
                        <div class="col-sm-5" style="min-height:550px;">
                             <div class="row">
                            <div class="col-sm-12 text-center "  style="min-height:50px;background-color: orangered;"><h1 style="color:white;font-family: Arial Rounded MT;margin-top: -0px;">Login Here</h1></div>
                            <div class="col-sm-2"></div>
                            <div class="col-sm-8">
                                <form class="form-horizontal" action="generalcode/logincode.jsp" method="post">
                                <br/>
                                <br/>
                                <br/>
                                <br/>
                                <label>Email Address:</label>
                                <input type="email" name="emailaddress" placeholder="Enter your email" class="form-control" required/>
                                <br/>
                                ...
                                <br/>
                                <span>If you are not registered ?<a href="registration.jsp">Register Here</a></span>
                            </div>
                            <div class="col-sm-2"></div>
                            </div>
                        </div>
