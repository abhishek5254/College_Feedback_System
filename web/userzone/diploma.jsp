      ...
      <ul class="nav navbar-nav navbar-right"style="font-size: 16px;" >
        ...
        <li><a href="aboutus.jsp"> ABOUT US</a></li>
         <li  role="presentation"  ><a href="engineering.jsp">ENGINEERING CLG  <span class="badge">42</span></a></li>
          <li role="presentation" ><a href="medical.jsp">MEDICAL CLG  <span class="badge">34</span></a></li>
           <li role="presentation" ><a href="management.jsp">MANAGEMENT CLG. <span class="badge">56</span></a></li>
            <li role="presentation" ><a href="iit.jsp">IIT CLG  <span class="badge">23</span></a></li>
             <li role="presentation" class="active" ><a href="diploma.jsp">DIPLOMA CLG  <span class="badge">768</span></a></li>
